        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-capitalize text-center py-4">
                    ...
                    <h3>Hapus Master Tahun Akademik?</h3>
                    <div class="">
                        anda yakin akan menghapus data Master Tahun Akademik?
                    </div>
    ...
    <div class="modal modal-blur fade" id="modal-edit" tabindex="-1" role="dialog" aria-hidden="true"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <div class="modal-title">
                        Edit Data Master Tahun Akademik
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-capitalize py-2">
                    <fieldset class="form-fieldset">
                        <div class="mb-3">
                            <label class="form-label required" for="edit-thn_aka">Tahun Akademik</label>
                            <input type="text" class="form-control" name="thn_aka" id="edit-thn_aka" autocomplete="off"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        Tambah Data Master Tahun Akademik
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body py-4">
                    <fieldset class="form-fieldset">
                        <div class="mb-3">
                            <label class="form-label required" for="thn_aka">Tahun Akademik</label>
...
<form id="formImport" enctype="multipart/form-data" class="mainForm"
    ...
    <div class="modal modal-blur fade" id="modal-import" tabindex="-1" role="dialog" aria-hidden="true"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Import Data Master Tahun Akademik</h5>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        $('.mainForm').on('submit', function (e) {
            ...
            if (formId === "deleteForm") {
                url = '{{route('admin.master-data.tahun-akademik.destroy',':id')}}'
                url = url.replace(':id', id_action)
                tipe = 'DELETE';
                data = $(this).serialize();
            } else if (formId === "editForm") {
                url = '{{route('admin.master-data.tahun-akademik.update',':id')}}'
                url = url.replace(':id', id_action)
                tipe = 'PUT';
                data = $(this).serialize();
            } else if (formId === "addForm") {
                url = '{{route('admin.master-data.tahun-akademik.store')}}'
                tipe = 'POST';
                data = $(this).serialize();
