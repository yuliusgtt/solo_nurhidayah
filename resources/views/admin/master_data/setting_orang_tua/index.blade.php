                        ...
                        <ul class="list-group list-group-timeline mb-3">
                            ...
                            <li class="list-group-item list-group-timeline-danger">Contoh file yang dapat diproses untuk import:
                                <a class="btn btn-sm btn-outline-primary fw-bolder"
                                   href="{{asset('contoh_excel/Nurhid Solo Format Excel Import Kontak Ortu.xls')}}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body py-4">
                        <div class="row mb-3 text-center">
                            ...
                            <h3>Simpan Data Setting Orang Tua?</h3>
                            <div class="">
                                Anda yakin ingin menyimpan data  Setting Orang Tua yang telah diimport?
                            </div>
                        </div>
{{--                        <div class="row mb-3">--}}
{{--                            <div class="col">--}}
            ...
            document.querySelectorAll(".mainForm").forEach(form => {
                form.addEventListener("submit", function (e) {
                    ...
                    if (formId === "formImport") {
                        ...
                        url = '{{route('admin.master-data.setting-orang-tua.validate-data')}}';
                        method = 'POST';
                    }
