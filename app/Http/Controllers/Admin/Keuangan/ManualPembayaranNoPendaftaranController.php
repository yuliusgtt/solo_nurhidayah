...
class ManualPembayaranNoPendaftaranController extends Controller
{
    public function __construct()
    {
        $this->title = 'Keuangan';
        $this->mainTitla = 'Manual Pembayaran No. Pendaftaran';
        $this->dataTitle = 'Manual Pembayaran No. Pendaftaran';
        $this->showTitle = 'Detail Manual Pembayaran No. Pendaftaran';
...
//        $data['kelas'] = mst_kelas::get();
        ...
        return view('admin.keuangan.manual_pembayaran_no_daftar', $data);
    }
}
